...
public final class GifDecoder {
    private static final class BitReader {
        ...
        private int numBits;
        /**
         * Use to kill unwanted higher bits
         */
        private int bitMask;
        /**
         * Data array
    ...
    static final class CodeTable {
        /**
         * Maps codes to lists of colors
         */
        private final int[][] tbl;
        /**
         * Number of colors +2 for CLEAR + EOI
         */
        ...
        /**
         * Current code size, maximum is 12 bits
         */
        private int codeSize;
        /**
         * Next available code for a new entry
         */
        private int nextCode;
        /**
         * Increase codeSize when nextCode == limit
         */
        private int nextCodeLimit;
        /**
         * Notify when code sizes increases
         */
        ...
        private int clear() {
            ...
            // Don't recreate table, reset pointer
    ...
    private final class GifFrame {
        ...
        /**
         * Unsigned, LSByte first, n * 1/100 * s
         */
        private int delay;
        /**
         * 1 Byte
         ...
         * Image descriptor
         * <p>
         * Position on the canvas from the left
         */
        private int x;
        /**
         * Position on the canvas from the top
         */
        private int y;
        /**
         * May be smaller than the base image
         */
        private int w;
        /**
         * May be smaller than the base image
        ...
        private int wh;
        /**
         * Has local color table? 1 Bit
         */
        private boolean hasLocColTbl;
        /**
         * Is an interlace image? 1 Bit
         */
        private boolean interlaceFlag;
        /**
         * True if local colors are sorted, 1 Bit
         */
        private boolean sortFlag;
        /**
         * Size of the local color table, 3 Bits
         */
         ...
         * Image data
         * <p>
         * LZW minimum code size + 1 for CLEAR & EOI
         */
        private int firstCodeSize;
        private int clearCode;
        private int endOfInfoCode;
        /**
         * Holds LZW encoded data
         */
        private byte[] data;
        /**
         * Full drawn image, not just the frame area
         */
    ...
    public final class GifImage {
        ...
        String header;
        /**
         * Unsigned 16 Bit, least significant byte first
         */
        private int w;
        /**
         * Unsigned 16 Bit, least significant byte first
         ...
         * 1 Bit
         */
        boolean hasGlobColTbl;
        /**
         * 3 Bits
         */
        int colorResolution;
        /**
         * True if global colors are sorted, 1 Bit
         */
        boolean sortFlag;
        /**
         * 2^(val(3 Bits) + 1), see spec
         */
        int sizeOfGlobColTbl;
        /**
        ...
        /**
         * 8 Bytes at in[i+3], usually "NETSCAPE"
         */
        String appId = "";
        /**
         * 3 Bytes at in[i+11], usually "2.0"
         */
        String appAuthCode = "";
        /**
         * 0: infinite loop, N: number of loops
         */
        int repetitions = 0;
        /**
        ...
        private int[] decode(final GifFrame fr, final int[] activeColTbl) {
            ...
            while (true) {
                ...
                if (code == clearCode) {
                    ...
                    System.arraycopy(pixels, 0, out, outPos, pixels.length);
                    outPos += pixels.length;
                    // Back to the loop with a valid previous code
                    continue;
        ...
        private int[] deinterlace(final int[] src, final GifFrame fr) {
            ...
            // All pixel lines have now been rearranged
            return dest;
        }
        ...
        private void drawFrame(final GifFrame fr) {
            ...
            prevPx = new int[wh];
            System.arraycopy(((DataBufferInt) img.getRaster().getDataBuffer()).getData(), 0, prevPx, 0, wh);
            // Create another copy for the end user to not expose internal state
            // 2 = ARGB
            fr.img = new BufferedImage(w, h, 2);
            System.arraycopy(prevPx, 0, ((DataBufferInt) fr.img.getRaster().getDataBuffer()).getData(), 0, wh);
            ...
            if (fr.disposalMethod == 2) {
                ...
                System.arraycopy(prevPx, 0, ((DataBufferInt) img.getRaster().getDataBuffer()).getData(), 0, wh);
            }
        }
        ...
        public List<BufferedImage> getFrames() {
            List<BufferedImage> frameImgList = new ArrayList<>();
            frames.forEach(fr -> frameImgList.add(fr.img));
            return frameImgList;
        }
    ...
    private static GifImage read(final byte[] in) throws IOException {
        ...
        GifFrame frame = null;
        // Read header, get next byte position
